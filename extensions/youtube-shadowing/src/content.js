(function audioFilmsYouTubeShadowing() {
  ...
  const ribbonPanelController = ribbonPanelContentWorkflowApi.createRibbonPanelController({
    ...
    panelId: RIBBON_PANEL_ID,
    iconSvg,
    bugIconSvg,
    ribbonControls: ribbonControlsApi,
    ribbonPanelFactory: ribbonPanelFactoryApi,
  ...
  const panelLayoutController = panelLayoutContentWorkflowApi.createPanelLayoutController({
    getState: () => state,
    panelLayoutWorkflow: panelLayoutWorkflowApi,
    panelLayout: panelLayoutApi,
    panelLayoutDom: panelLayoutDomApi,
  ...
  const diagnosticsController = diagnosticsContentWorkflowApi.createDiagnosticsController({
    getState: () => state,
    diagnosticsWorkflow: diagnosticsWorkflowApi,
    diagnosticsFormatWorkflow: diagnosticsFormatWorkflowApi,
    diagnosticsReport: diagnosticsReportApi,
  ...
  const keyboardController = keyboardContentWorkflowApi.createKeyboardController({
    getState: () => state,
    keyboardWorkflow: keyboardWorkflowApi,
    isWatchPage: youtubeAdapterApi.isWatchPage,
    keyboardShortcuts: keyboardShortcutApi,
  ...
  const displayStateController = displayStateContentWorkflowApi.createDisplayStateController({
    getState: () => state,
    displayPreferenceWorkflow: displayPreferenceWorkflowApi,
    uiStateWorkflow: uiStateWorkflowApi,
    displayPreferences: displayPreferencesApi,
  ...
  const ribbonContentController = ribbonContentWorkflowApi.createRibbonContentController({
    getState: () => state,
    sourceSelectorWorkflow: sourceSelectorWorkflowApi,
    sourceSelector: sourceSelectorApi,
    sourceSelectorDom: sourceSelectorDomApi,
    sourceReadiness: sourceReadinessApi,
    sourceLabels: sourceLabelsApi,
    captionTracks: captionTrackApi,
    phraseRowsWorkflow: phraseRowsWorkflowApi,
    phraseRows: phraseRowsApi,
    phraseRowsDom: phraseRowsDomApi,
    selectedSpanWorkflow: selectedSpanWorkflowApi,
    selectedSpans: selectedSpanApi,
    getSelectedPracticeSource,
    practiceReadiness,
