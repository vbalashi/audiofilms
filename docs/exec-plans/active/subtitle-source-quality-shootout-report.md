...
Generated: 2026-06-11T11:32:02.245Z
...
| normal-manual (4EE7m94mJpk) | candidate | medium | 0.717 | 0.912 | Manual and ASR text partially match; alignment may work only after better normalization and local-window matching. |
...
| provider-fallback-stress (KrdVIUmBoE4) | candidate | high | 0.808 | 0.782 | Manual and ASR text are close enough for a lightweight token-alignment experiment. |
...
| Fixture | Source | Status | Provider | Track | Raw | Normalized | Flags | Max cue | Longest cue | Sample |
| --- | --- | --- | --- | --- | ---: | ---: | --- | ---: | --- | --- |
| manual-asr-divergence (RJrjzCuCHpo) | yt-dlp-manual | ok | yt-dlp | nl | 138 | 138 | long-cues, duplicate-text | 22.28 | En we laten zien dat de politie ouders oproept... | Goedemiddag. |
| manual-asr-divergence (RJrjzCuCHpo) | yt-dlp-auto | ok | yt-dlp | nl-orig | 384 | 187 | phrase-sized | 4.95 | Meer eh schoenen, sjaals, petten, tassen, van alles. | Goedemiddag. |
| normal-manual (4EE7m94mJpk) | yt-dlp-manual | ok | yt-dlp | nl | 185 | 185 | duplicate-text | 7.48 | Ons sterrenstelsel, de Melkweg is een enorme wervelende oase van honderden miljarden sterren. | Kijk goed. |
| normal-manual (4EE7m94mJpk) | yt-dlp-auto | ok | yt-dlp | nl-orig | 446 | 233 | duplicate-text, phrase-sized | 4.6 | ster met ronddraaiende planeten heet een planetenstelsel en de onze heet het | Kijk goed, maar echt goed. |
| auto-only (xymyDvCgWDA) | yt-dlp-manual | not-found | yt-dlp |  | 0 | 0 | empty | 0 |  | No matching track key |
| auto-only (xymyDvCgWDA) | yt-dlp-auto | ok | yt-dlp | nl-orig | 144 | 67 | duplicate-text, phrase-sized | 4.23 | bekwaamheid te behouden Kortom bekwaam blijf je door te [Muziek] | [Muziek] als ambulancezorg professional ben je |
...
| provider-fallback-stress (KrdVIUmBoE4) | yt-dlp-manual | ok | yt-dlp | nl | 162 | 162 |  | 7.846 | Het is met bloed gebouwd. We dansen straks op graven van 6500 mensen. | Hey, kijk mee. |
| provider-fallback-stress (KrdVIUmBoE4) | yt-dlp-auto | ok | yt-dlp | nl-orig | 572 | 292 | duplicate-text, phrase-sized | 4.639 | "FIFA sta op." There are real risks for them, including they may | Hey, kijk mee. |
| multilingual-manual (aircAruvnKk) | yt-dlp-manual | ok | yt-dlp | en | 286 | 286 |  | 7.962 | to the connections between one layer and a particular neuron in the next layer. | This is a 3. |
| multilingual-manual (aircAruvnKk) | yt-dlp-auto | ok | yt-dlp | en-orig | 984 | 487 | duplicate-text, phrase-sized | 3.35 | Remember how earlier I said these neurons are | This is a three. |
...
- yt-dlp-auto: ok; raw 446, normalized 233; flags duplicate-text, phrase-sized; max 4.6s.
...
- yt-dlp-auto: ok; raw 144, normalized 67; flags duplicate-text, phrase-sized; max 4.23s.
...
- yt-dlp-auto: ok; raw 572, normalized 292; flags duplicate-text, phrase-sized; max 4.639s.
...
- yt-dlp-auto: ok; raw 984, normalized 487; flags duplicate-text, phrase-sized; max 3.35s.
