...
export function practiceTimingInputFromBody(
  ...
  return {
    ...
    audioTrackId: job.request.audioTrackId,
    audioTrackCount: job.request.audioTrackCount,
    audioLanguage: job.request.audioLanguage,
    audioProvenance: job.request.audioProvenance,
    audioEvidence: job.request.audioEvidence,
