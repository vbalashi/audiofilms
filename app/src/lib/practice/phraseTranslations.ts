...
export function projectPhraseTranslation(
  ...
  const output: PhraseTranslation = {
    ...
    contextTextHash: platform.contextTextHash || (input.contextText ? hashText(input.contextText) : undefined),
...
export async function savePhraseTranslationAssociation(
  ...
  const stored: StoredPhraseTranslationAssociation = {
    ...
    contextTextHash: translation.contextTextHash || (input.contextText ? hashText(input.contextText) : undefined),
    purpose: input.purpose,
...
export function publicPhraseTranslationFromStored(
  ...
  return {
    ...
    contextTextHash: stored.contextTextHash,
